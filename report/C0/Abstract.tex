...
This report describes a novel program synthesis system, focusing on the learning on functional programs. The system learns Haskell programs given an incomplete specification in the form of a set of Input / Output examples. Through use of Answer Set Programming (ASP) this system implements two approaches to program synthesis. The first makes use of a Haskell interpreter implemented in ASP, and the second maintains a set of ``Equality Constraints'', which fail if some contradiction is reached. \\ \\
